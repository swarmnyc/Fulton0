...
let ModelTests = class ModelTests {
    ...
    testVersionIsIncrementedProperly(attr) {
        ...
        alsatian_1.Expect(newAttr["_v"]).toEqual(1);
    }
    testSavingModel() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let model = new TestModel();
            model = (yield model.validate()); //will add the default _v value
            console.log(model.schema());
            alsatian_1.Expect(model.get("_v")).toEqual(0);
            model = (yield model.setAndValidate({ "_v": 0 })); //should update _v to 1
            alsatian_1.Expect(model.get("_v")).toEqual(1);
        });
    }
...
__decorate([
    alsatian_1.TestCase(new TestModel({ "_v": 0 }))
], ModelTests.prototype, "testIsAllowedToSave", null);
__decorate([
    alsatian_1.TestCase(new TestModel({ "_v": 1 }))
], ModelTests.prototype, "testIsNotAllowedToSave", null);
__decorate([
    alsatian_1.TestCase({ "_v": 0 })
