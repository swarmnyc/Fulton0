export declare namespace OAuthGrants {
    interface IOAuthAccessTokenObject {
        accessToken: string;
        refreshToken?: string;
    ...
    interface IOAuthAccessTokenDefinition {
        accessToken: string;
        refreshToken?: string;
        accessTokenExpiresOn: Date;
        refreshTokenExpiresOn?: Date;
    ...
    interface ClientCredentialsGrant extends GenericGrant {
        getUserFromClient: (id: ClientId, secret: ClientSecret) => Promise<IUserObject>;
    }
    interface PasswordGrant extends GenericGrant {
        getUser: (username: string, password: string) => Promise<IUserObject>;
    }
    interface RefreshTokenGrant extends ClientCredentialsGrant {
